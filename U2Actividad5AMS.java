 ...
 * Descripción: compila y funciona,
 * Me ha costado mucho debido a que me cuesta entender los bucles pero poco a poco voy entendiendolos, tambien me costó plantear el problema.
 * 
 */
import java.util.Scanner;
public class U2Actividad5AMS {
	public static void main(String[] args) {
		...
		if(negativo){
			...
			System.out.printf("Han aprovat %.0f alumnos, lo que supone un %.2f per cent del total.\n",totalAprovats,percentatgeAprovats);
			if (totalAprovats==0){
